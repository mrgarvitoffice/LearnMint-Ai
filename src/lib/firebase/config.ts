...
// TEMPORARY HARDCODING FOR DEBUGGING - USER PROVIDED THIS KEY
const apiKeyFromEnv = "AIzaSyCNcktsyCTevZebTrc4aBnG4b0pRbYx4tk"; 

// Original attempt to read from .env
...
const firebaseConfig: FirebaseOptions = {
  apiKey: apiKeyFromEnv, // Using the (potentially hardcoded) key
