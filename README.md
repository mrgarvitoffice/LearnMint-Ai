...
*   AI Chatbot (Kazuma): `AIzaSyC3ZI8F99RYeMxkE5OYewSsE0o5GLHvMRs` (This key is also recommended for `GOOGLE_API_KEY_IMAGES` if you haven't used the dedicated image key below)
